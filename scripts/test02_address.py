...
class TestAddress:
    ...
    # 测试新增地址方法
    @pytest.mark.parametrize("name, phone, address, code, province, city, "
                             "area", get_data("add_address"))
    def test01_add_address(self, name, phone, address, code, province, city,
                                  area):
        # 调用地址管理新增业务方法
        self.address.page_address(name, phone, address, code, province, city,
                                  area)
        # 组合收件人 和电话
        expect = name + "  " + phone
    ...
    # 测试更新地址方法
    @pytest.mark.parametrize("name, phone, address, code, province, city, "
                             "area", get_data("update_address"))
    def test02_update_address(self, name, phone,
                              address, code, province,
                              city, area):
        # 调用更新业务方法
        self.address.page_update_address(name, phone, address, code, province,
                                         city, area)
        # 组合收件人 和电话
        expect = name + "  " + phone
